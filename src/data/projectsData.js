...
export const allProjectsData = [
  ...
  {
    id: 12,
    title: "Görev ve Not Yöneticisi (PWA)",
    category: "Full Stack / Web App",
    image: "/assets_img/projects/project_12.png",
    description:
      "React (Vite) ve Supabase kullanılarak geliştirilmiş, PWA (Progressive Web App) destekli modern bir görev ve not yönetim platformudur. İçerisinde dinamik takvim şeridi ile gün bazlı görev takibi, önceliklendirme (düşük/orta/yüksek) ve renk kodlamalı gelişmiş bir not alma modülü (Grid/Editor) barındırır. Tailwind CSS ile tasarlanmış tam duyarlı (responsive) ve karanlık/aydınlık mod (dark/light theme) destekli modern UI/UX arayüzü sayesinde profesyonel bir kullanıcı deneyimi sunar. Tüm veriler arka planda Supabase PostgreSQL veritabanında güvenle saklanmakta olup proje Vercel üzerinde barındırılmaktadır.",
    technologies: [
      "React (Vite)",
      "Tailwind CSS",
      "Supabase (PostgreSQL)",
    ...
    liveUrl: "https://github.com/BartuOzasci/Bartu_to_do_list",
    githubUrl: "https://github.com/BartuOzasci/Bartu_to_do_list",
    featured: true,
  },
];
